...
public class Constants {
	...
	public static final String EXPECTED_EXPENSEALERT="alert alert-success alert-dismissible";
	public static final String EXPECTED_UPDATEALERT="alert alert-success alert-dismissible";
   ...
   /**ManageProduct page**/
	...
	public static final String IMAGE_UPLOAD=System.getProperty("user.dir")+"\\src\\main\\resources\\ImageUpload";
	public static final String EXPECTED_ORDERALERT="alert alert-success alert-dismissible";
   ...
   /**Login page**/
	...
	public static final String EXPECTED_SIGNINTEXT="Sign in to start your session";
